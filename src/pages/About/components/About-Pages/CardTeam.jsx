    ...
    <div className="container mx-auto p-2">
      ...
      >
        {cart.slice(0, 8).map((item, index) => (
          <div
            key={index}
            className="bg-white rounded-lg shadow-2xl border border-gray-300 w-[300px] h-[420px] max-[800px]:w-[230px] max-[800px]:h-[360px] text-left flex flex-col mb-4"
          >
            <img className="w-full h-[220px] max-[800px]:h-[170px] object-contain rounded-lg mb-4" src={item.img} alt="" />
            <div data-aos="fade-down" className="text p-2">
              <h2 className="text-black-600 font-poppins text-[30px] max-[800px]:text-[25px] font-normal leading-relaxed">{item.title}</h2>
              <p className="w-[250px] max-[800px]:w-[200px] text-black-600 font-poppins text-base font-normal leading-relaxed overflow-hidden whitespace-nowrap overflow-ellipsis">
                {item.description}
              </p>
              ...
              <div className="flex justify-between">
                <button
                  className={`w-[135px] max-[800px]:w-[95px] h-[40px] flex items-center justify-center rounded-[10px] box-border border border-gray-200 shadow-md 
                    ${
